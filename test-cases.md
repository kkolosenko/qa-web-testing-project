...
| TC-055 | Enter unrealistic customer information during Checkout (negative test) | User is on the Checkout information page | 1. Enter unrealistic values in First Name, Last Name and Postal Code <br> 2. Click **Continue** | Expected validation behavior requires clarification from requirements | Confirmation order page opens after entering unrealistic values |  |
